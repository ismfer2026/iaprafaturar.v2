-- ============================================================
-- Phase 11 fix - auth.users.confirmed_at is generated.
--
-- The previous migration inserted email_confirmed_at and confirmed_at.
-- On the current Supabase Auth schema, confirmed_at is generated and
-- must not receive an explicit value. email_confirmed_at remains enough
-- to mark the email-password account as confirmed.
-- ============================================================
