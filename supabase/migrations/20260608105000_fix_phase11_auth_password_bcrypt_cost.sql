-- ============================================================
-- Phase 11 fix - use bcrypt cost 10 for GoTrue compatibility.
-- PostgreSQL crypt() accepts the default bf cost, but Supabase Auth
-- expects the usual GoTrue-compatible bcrypt work factor.
-- ============================================================
