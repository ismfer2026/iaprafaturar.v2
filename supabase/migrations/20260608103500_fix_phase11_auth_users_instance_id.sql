-- ============================================================
-- Phase 11 fix - hosted Supabase Auth users should not receive
-- the old zero UUID instance_id from the v1 direct-auth pattern.
-- ============================================================
...
WHERE instance_id = '00000000-0000-0000-0000-000000000000'::uuid
  AND id IN (
    ...
    WHERE onboarding_source = 'public_onboarding'
  );
