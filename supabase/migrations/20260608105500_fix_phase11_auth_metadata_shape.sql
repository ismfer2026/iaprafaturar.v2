-- ============================================================
-- Phase 11 fix - align direct Auth rows with GoTrue-created rows.
-- Hosted Supabase uses zero UUID instance_id and user metadata with
-- sub/email/email_verified/phone_verified for email-password users.
-- ============================================================
...
SET
  ...
  raw_user_meta_data = jsonb_build_object(
    ...
    'onboarding_source', p.onboarding_source,
